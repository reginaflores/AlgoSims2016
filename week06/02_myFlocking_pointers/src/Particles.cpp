...
ofPoint Particle::cohesion(vector<Particle> *particles){
    ...
    for(int i = 0; i < particles->size(); i++){
        ...
        //now you get the address like this:

        //step 1: deref pointer so tht you get a vector
//        vector<Particle> & actual_particles = *particles;
        //step2: get the ith particle: (*particles)[i]
        //step 3: get the address of the ith particle
        if (&(*particles)[i] == this) {
            continue;
        }
        
        //if you have a pointer to the array you have to use reference - to get what its pointing to
        
        //if you have a pointer and you want to deref the pointer you use star actual_var = *pointer
        
//        vector<Particle> &actual_particles = *particles;
//        centerMass += actual_particles[i].pos;
